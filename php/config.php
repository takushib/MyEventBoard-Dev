...
// based on example provided for phpCAS
// https://github.com/apereo/phpCAS/blob/master/docs/examples/config.example.php
...
$phpcas_path = 'vendor/jasig/phpcas/source/CAS.php';
